...
<head>
    ...
    <link rel="stylesheet" href="../../Frontend/create-order/create-order.css">
...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center py-5">
                    ...
                    <p class="text-muted mb-4">Order <strong id="orderNumber">#0000</strong> has been created.</p>
                    ...
                    <div class="p-4 bg-light">
                        ...
                        <div class="bg-white p-3 rounded border border-dashed">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <small>$<span id="prevSubtotal">0.00</span></small>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                                <small>Tax (5%):</small>
                                <small>$<span id="prevTax">0.00</span></small>
                            </div>
    ...
    <!-- Create Order Logic -->
    <script src="../../Frontend/create-order/create-order.js"></script>
</body>
